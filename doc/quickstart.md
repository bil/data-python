...
```
    ...
    U201130_01.yaml: 48.0iB [00:00, 62.0kiB/s]
...
```
    ...
    df/trial.df.xz: 25.6kiB [00:00, 55.7MiB/s]
...
```
    ...
    U201130_01.h5: 221kiB [00:00, 75.1MiB/s]
...
```
    ...
    signal/pos_cursor_x.h5: 10.9MiB [00:00, 81.9MiB/s]


    Copying signal/pos_cursor_y.h5 to tmp/U201130_01...


    signal/pos_cursor_y.h5: 10.9MiB [00:00, 82.7MiB/s]
    ...
    neural/lfp_1k.h5: 905MiB [00:16, 56.3MiB/s] 
...
![png](quickstart_files/quickstart_19_7.png)
